...
SCENARIOS = [
    ...
    {"num": 2, "label": "Depression-Era Rally Peak", "short": "Depression Rally", "date": 1937.02, "crash": "−60%", "peak_desc": "Peak before −60% plunge",
     ...
     "pain": "Two consecutive crashes within a decade. Industrial production dropped 37%. Unemployment surged from 14% back to 19%. Congressman Maury Maverick said: \"We have pulled all the rabbits out of the hat, and there are no more rabbits.\" It took until 1945 to break even on price alone.",
     "quote": "We have tried spending money. We are spending more than we have ever spent before and it does not work. I say after eight years of this Administration we have just as much unemployment as when we started. And an enormous debt to boot!",
     "quote_attr": "Henry Morgenthau Jr., Treasury Secretary — private diary, May 1939"},
